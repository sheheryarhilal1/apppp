        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 40), // Add some spacing between the image and the button
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.green, // Button color
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(30.0), // Rounded rectangle shape
                  ),
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => QRCodeScanner()), // Replace with your target screen
                  );
                },
                child: const Text(
                  'Get Started',
